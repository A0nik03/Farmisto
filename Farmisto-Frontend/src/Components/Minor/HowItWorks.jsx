...
const HowItWorks = () => {
  ...
  const cells = [
    ...
    { id: 3, content: "Step 2: Radius-Based Matching" },
    { id: 4, content: "Step 3: Farmer Dashboard" },
    { id: 5, content: "Step 4: Retailer Section" },
    { id: 6, content: "Step 5: Farm Supply & Retailer Interaction" },
    { id: 7, content: "Step 6: Promotes Fair Trade" },
  ];

  return (
    <div className="w-full h-[70vh] bg-zinc-100 mx-auto flex flex-col justify-center items-center py-8 gap-8">
      <div
        className="svg"
        style={{
        ...
        <div className="gallery flex justify-center items-center flex-wrap gap-8">
          {Object.values(images).map((img, index) => {
            return (
              ...
              >
                <h3 className={`text-center ${index === 1 ? "text-2xl" : "text-md"} text-white font-bold`}>
                  {cells[index].content}
                </h3>
              </div>
            );
