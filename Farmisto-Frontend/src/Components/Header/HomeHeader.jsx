      ...
      <div className="h-full w-full flex">
        <div className="w-2/3 h-full p-5 pl-5 ml-20">
          <div className="h-full w-full p-10">
            ...
            <div className="h-12 mt-5 w-[58%] z-50 border border-green-800 rounded-full flex items-center gap-2 px-2">
              <span className="z-50 h-2 w-2 bg-green-800 rounded-full" />
              <p className="z-50 text-xl text-green-800 font-normal">
        ...
        <div className="w-1/3 h-full px-16 py-7">
          <div
            className="w-96 h-[70vh] overflow-hidden shadow-2xl"
            style={{
